...
ActiveRecord::Schema.define(version: 2024_06_20_180805) do
  ...
  create_table "user_responses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.bigint "survey_id"
    t.bigint "question_id"
    t.bigint "answer_id"
    t.datetime "created_at", null: false
    ...
    t.index ["survey_id"], name: "index_user_responses_on_survey_id"
  end
